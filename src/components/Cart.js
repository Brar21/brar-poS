      ...
      {suggestions.length > 0 && (
        <div className="bg-white border rounded shadow mt-1 max-h-40 overflow-y-auto">
          {suggestions.map((c) => (
            ...
            >
              <p className="text-black">{c.name || "No Name"}</p>
      ...
      <div className="p-4 border-t space-y-3">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`flex-1 py-2 text-black rounded-xl ${paymentMethod === "CASH"
                ? "bg-black text-white"
                : "bg-gray-200"
              }`}
          >
          ...
          <button
            ...
            className={`flex-1 py-2 text-black rounded-xl ${paymentMethod === "UPI"
          ...
          <button
            ...
            className={`flex-1 py-2 text-black rounded-xl ${isCredit ? "bg-red-600 text-white" : "bg-gray-200"
              }`}
          >
            {isCredit ? "Udhaar Active" : "Mark as Udhaar"}
          </button>
        </div>
